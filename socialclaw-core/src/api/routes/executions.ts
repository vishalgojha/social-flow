...
import { readExecution } from '../../services/repository';
...
export function registerExecutionRoutes(app: FastifyInstance) {
  app.post('/v1/workflows/:workflowId/execute', {
    ...
    await query(
      ...
      [executionId, req.user!.tenantId, body.clientId, params.workflowId, 1, body.triggerType, JSON.stringify(body.triggerPayload || {})]
    );
